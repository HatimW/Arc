var Arc = (() => {
  var STORAGE_KEY = "arc-ui-preferences";
  var DB_NAME = "arc-db";
  var MEMORY_STORAGE_KEY = "arc-memory-db";
  var MAP_CONFIG_BACKUP_KEY = "arc-map-config-backup";
  var DATA_BACKUP_KEY = "arc-backup-snapshot";
